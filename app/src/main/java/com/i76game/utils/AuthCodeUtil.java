...
//	    }     
	    ...
	    private static String authcode(String source, String key,
	        ...
	        try {     
	            ...
	            if (operation == DiscuzAuthcodeMode.Decode) {     
	                ...
	                System.out.println("keyc+Base64.encodeToString==="+keyc+ Base64.encodeToString(temp, 0));
	    ...
	    public static void main(String[] args) {
	        ...
	        String deStr = AuthCodeUtil.authcodeDecode(afStr, key);
	        System.out.println("--------decode:" + deStr);
	        String deStr1 = AuthCodeUtil.authcodeDecode("HeGUeCVbBYBdVwK9aSGwi0b1B2sfdClZSpjR", "czyb");
