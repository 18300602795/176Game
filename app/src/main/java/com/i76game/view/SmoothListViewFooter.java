...
public class SmoothListViewFooter extends LinearLayout {
	...
	public final static int STATE_ZERO= 3;
	public final static int STATE_NOMORE = 4;
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.smoothlistview_footer_no_more);
		}else if(state == STATE_ZERO){
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.smoothlistview_footer_zero);
		}else {
			mHintView.setVisibility(View.VISIBLE);
