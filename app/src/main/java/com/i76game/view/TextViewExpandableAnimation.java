...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    public TextViewExpandableAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initValue(Context context, AttributeSet attrs) {
       ...
       textViewStateColor = ta.getColor(R.styleable.TextViewExpandableAnimation_tvea_textStateColor, ContextCompat.getColor(context,R.color.zixun_text_2) );
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context,R.mipmap.arrow_down);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context,R.mipmap.arrow_down);
        }
        ...
        textContentSize = ta.getDimension(R.styleable.TextViewExpandableAnimation_tvea_textContentSize, 25);
